...
# NOTE: no trailing slash on these paths. They land in
# ALL_DEFAULT_INSTALLED_MODULES and therefore in the vendor partition's
# file_list.txt, and build_image.py requires every entry to equal
# os.path.normpath() of itself:
#   rfs/msm/adsp/: not normalized
# $(dir $@) used to resolve to the directory itself thanks to that slash, so it
